--this is a testing file and not actual nova
local library = loadstring(game:HttpGet("https://raw.githubusercontent.com/Consistt/Ui/main/UnLeaked"))()


library.rank = "User"
local Wm = library:Watermark("Spectrum Blood Debt | v" .. library.version ..  " | " .. library:GetUsername() .. " | rank: " .. library.rank)
...
for i = 20,0,-1 do 
    task.wait(0.05)
    local LoadingXSX = Notif:Notify("Loading spectrum...")
end 

library.title = "Spectrum"
